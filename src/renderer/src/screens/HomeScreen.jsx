...
export function HomeScreen() {
  ...
  const oliveColor = '#5C6B2E';

  const t = {
    barrierTitle: { ko: '어떤 안내가 필요하세요?', en: 'What assistance do you need?', ja: 'どんなご案내が必要ですか？', zh: '您需要什么帮助？' },
    ...
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <img src="bef5.png" alt="배프" style={{ width: '75px', height: 'auto' }} />
          <div
            onClick={() => set배프모드(v => !v)}
            style={{
              width: '64px', height: '32px', borderRadius: '16px',
              background: 배프모드 ? oliveColor : '#BBB',
          ...
          >
            ...
            <span style={{
              ...
              left: 배프모드 ? '6px' : 'auto',
              right: 배프모드 ? 'auto' : '6px',
              fontSize: '11px', fontWeight: 'bold', color: '#FFF', userSelect: 'none',
            }}>
              {배프모드 ? 'ON' : 'OFF'}
            </span>
          </div>
        ...
        <button onClick={일반시작} style={{
          ...
          cursor: 'pointer', zIndex: 10, borderRadius: '30px',
        }} />
      ...
      <div style={{
        ...
        <button onClick={() => setA11yOpen(true)} style={{ background: 'transparent', border: 'none', padding: 0, cursor: 'pointer' }}>
          <img src="disabled.png" alt="접근성" style={{ width: '44px', height: '44px', objectFit: 'contain' }} />
        </button>
        <div style={{ display: 'flex', gap: '4px', border: '1.5px solid rgba(255,255,255,0.5)', borderRadius: '8px', padding: '3px 5px', alignItems: 'center' }}>
